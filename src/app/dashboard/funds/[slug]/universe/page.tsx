...
export default async function FundUniversePage({
  ...
  const rows = universeRows.map((r) => ({
    ...
    name: r.name,
    exchange: r.exchange,
    currency: r.currency as "GBP" | "USD" | "EUR",
  ...
  return (
    <main style={{ padding: "28px 32px 64px" }}>
      ...
      >
        ...
        its security page and place a trade. The investable universe is
        managed by admins — request additions through the trade memo workflow.
      </div>
